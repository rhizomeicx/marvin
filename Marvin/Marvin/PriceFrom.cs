...
namespace Marvin.bots
{
    static class PriceFrom
    {
        ...
        public static BigInteger Binance(string ticker)
        {
            try
            {
                ...
                return (BigInteger)(1 / price * Math.Pow(10, 18));
            }
            catch
            {
                return 0;
        ...
        public static BigInteger Coingecko(string ticker)
        {
            try
            {
        ...
        public static BigInteger CoinMarketCap(string ticker)
        {
            try
            {
        ...
        public static BigInteger Velic()
        {
            try
            {
